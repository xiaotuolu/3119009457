...
def handle_app_click(session, appkey, version, environment, proxy):
    ...
    response = cenrest.call_rest_post(
        session.endpoint, method, body, headers, environment.get_certpath(), proxy, environment.get_debug())
    ...
    if ('elevate' in response.url):
        ...
        response = cenrest.call_rest_post(
            session.endpoint, method, json_body, headers, environment.get_certpath(), proxy, environment.get_debug())
